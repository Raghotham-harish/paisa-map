...
/* ── lever-fit radar ─────────────────────────────────────────────────────── */
function Radar({ levers }: { levers: ForecastResult["lever_fit_radar"] }) {
  ...
  const poly = levers.map((l, i) => pt(i, (Math.max(0, Math.min(100, l.lever_fit ?? 0)) / 100) * R).join(",")).join(" ");
  return (
            ...
            <>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 20, marginBottom: 24 }}>
                <div className="card">
                  ...
                  <Radar levers={f.lever_fit_radar} />
                  <p className="wiz-hint">Correlation of each lever with your stores' revenue. Weak spokes = you're tracking a signal that doesn't predict your sales.</p>
                </div>
