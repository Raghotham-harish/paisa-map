...
import { ApiError, DriverAnalysis, LocationScore, LocationStatus, PricingConfig, Project, SavedLocation, api, insufficientCreditsMessage, isSpendGate } from "../../lib/api";
...
// A categorical palette (identity, not magnitude) shared with the Forecast
// comparison radar via chartTheme.LOC_COLORS — deliberately NOT the map's
// diverging index ramps, so "these are N distinct places" never reads as a
// magnitude scale. Fixed order, never cycled. Capped at MAX_COMPARE (5).
const LOC_COLORS = ["#216A0B", "#2a78d6", "#eb6834", "#8A5A00", "#7d3ac1"];
