...
# a v2 id on a company is ignored (fail closed) until v2 enforcement exists
sql("UPDATE organizations SET plan = 'v2_scale' WHERE id = :o", o=org_o)
check(A.get_effective_plan_for_user(member) == "free", "a v2 company plan is ignored, not silently promoted or misread")
